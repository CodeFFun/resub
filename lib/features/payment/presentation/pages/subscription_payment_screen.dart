...
class _SubscriptionPaymentScreenState
  ...
  List<PaymentEntity> _filterSubscriptionPayments(
    List<PaymentEntity> payments,
  ) {
    return payments.where((payment) {
      // Filter to only include payments where at least one order has subscriptionId
      // but orderItemsId is empty/null
      ...
      return payment.orders!.any(
        (order) =>
            ...
            (order.orderItemsId == null || order.orderItemsId!.isEmpty),
      );
    }).toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final filteredPayments = _filterSubscriptionPayments(allPayments);
