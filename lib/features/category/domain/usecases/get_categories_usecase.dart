...
final getAllProductCategoriesUsecaseProvider =
    Provider<GetAllProductCategoriesUsecase>((ref) {
      final categoryRepository = ref.read(categoryRepositoryProvider);
      return GetAllProductCategoriesUsecase(
...
class GetAllProductCategoriesUsecase
  ...
  Future<Either<Failure, List<CategoryEntity>>> call() {
    return _categoryRepository.getAllProductCategories();
  }
}
